...
export async function POST(request: NextRequest) {
  try {
    ...
    // Read the JWT the client sends in the Authorization header
    ...
    // Verify the token belongs to the claimed user by decoding JWT locally
    // (avoids an extra network round-trip to Supabase auth server)
    ...
    // Use the user's JWT to authenticate Supabase queries — RLS enforces data isolation
